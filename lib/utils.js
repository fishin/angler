...
module.exports = internals.User = function (settings) {
    ...
    internals.User.getUsers = exports.getUsers;
    internals.User.getUserByName = exports.getUserByName;
    internals.User.createUser = exports.createUser;
    internals.User.deleteUser = exports.deleteUser;
    internals.User.updateUser = exports.updateUser;

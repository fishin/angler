...
describe('user', function () {    
    ...
    it('GET /api/user/byname/{name}', function (done) {
        ...
        internals.prepareServer(function (server) {
            ...
            server.inject({ method: 'GET', url: '/api/users'}, function (response) {
                ...
                server.inject({ method: 'GET', url: '/api/user/byname/' + name}, function (response) {
        ...
        internals.prepareServer(function (server) {
            ...
            server.inject({ method: 'GET', url: '/api/users'}, function (response) {
                ...
                server.inject({ method: 'POST', url: '/api/user/' + id, payload: payload}, function (response) {
                    ...
                    //console.log(response.result);
                    expect(response.statusCode).to.equal(200);
                    expect(response.result.displayName).to.equal('Lloyd Benson');
                    done();
                });
            });
        });
